...
It is quite obvious that the results we obtained depend a lot on the parameters we have chosen. We used 4 as the number of vertices to which each vertex is connected; increasing such quantity would allow for a faster rumor propagation.
We also used 0.05 as the rewiring probability; increasing such probability would make the networks more alike random graphs.
